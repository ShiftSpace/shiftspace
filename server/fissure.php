...
<?php method_form('post', 'event.post', array('stream_id', 'display_string', 'object_ref', 'has_read_status', 'unique_name', 'datetime_ref')); ?>
...
<?php method_form('post', 'event.getstreams', array('meta', 'object_ref')); ?>
