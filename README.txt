...
(http://community.shiftspace.org/). If you just want to install
ShiftSpace (the client userscript) you don't need to follow these
directions, just go to ShiftSpace.org and click the install button.
...
once you've been granted a Subversion account.
    ...
    http://shiftspace.org/releases/nightly.zip. When you unzip the
    ...
    http://git.or.cz/#documentation. To install the Git software,
    ...
    git://github.com/ShiftSpace/shiftspace.git. To download the latest
