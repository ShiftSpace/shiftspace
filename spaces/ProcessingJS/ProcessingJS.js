var ProcessingJSSpace = ShiftSpace.Space.extend({
  attributes :
  {
    name : 'ProcessingJS',
    version : 0.1, 
    icon : 'ProcessingJS.png',
    css: 'ProcessingJS.css'
  }
});

var ProcessingJSSpaceShift = ShiftSpace.Shift.extend({
  ...
  setup: function(json)
  {
    ...
    this.xmlhttpRequest({
      ...
      'onerror': function(response) {
        console.error("Error: Oops, " + response);
      }.bind(this)
    });
  },
  ...
  build: function()
  {
    this.element = new ShiftSpace.Element('canvas', {
      'class': "ProcessingJSShift",
      width: '200',
      height: '200'
    });
...
var ProcessingJS = new ProcessingJSSpace(ProcessingJSSpaceShift);

// The below was just pasted in from Processing.js directly
