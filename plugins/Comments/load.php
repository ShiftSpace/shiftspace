    ...
    <li id='com-2' class='comment original'>
  		<div class='com-meta'>
  			<div class='com-meta-text'>
  				<span class='com-num'>$num. </span><a class='com-author' title='Browser $currentComment->username\'s shifts on the ShiftSpace Public Square' href='http://www.shiftspace.org/shifts/?filter=by&filterBy=$currentComment->username'>$currentComment->username</a> said <span class='time-ago'>($date)</span>:
  			</div>
