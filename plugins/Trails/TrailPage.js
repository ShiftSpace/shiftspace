...
var TrailPage = new Class({
  ...
  initialize : function( el, options )
  {
    ...
    {
      // legacy trail
      var space = this.options.icon.split('/').getLast().split('_')[0];
  ...
  */
  zoom : function()
  {
        ...
        !this.isClosing )
    {
      ...
      if(!linkMode)
      {
        //SSLog('SET FOCUSED NODE ' + this.isCreatingLink);
  ...
  */
  deleteLinkMode : function()
  {
    ...
    //SSLog('adding click evento scroll area');
    var self = this;
    $('SSTrailsPlugInScrollArea').addEvent( 'click', function( e ) {
      ...
      {
        //SSLog('SSTrailsPlugInScrollArea click!');
        // clear deletions
