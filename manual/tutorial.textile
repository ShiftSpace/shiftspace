...
$ python shifty.py runserver</pre>
        ...
        <p>
            Now point your browser to the <a target="new" href="http://localhost:8080/sandbox/">sandbox</a>. Open the console with the <b>shift+space</b> key combination. If you haven't created an account do so now (remember this is saving to your local CouchDB). If you have, just login using your username and password.
        </p>
        <p>
        ...
        <p>
            Click on the <b>Space Menu</b> (first button on the lower left). Select the HelloWorld space. You should see a new orange shift appear on the page. Try dragging it around. Note that when you let go it gets saved and appears in the console.
        </p>
        <p>
