...
var Element = new Native({
	...
	initialize: function(tag, props){
		...
		if (typeof tag == 'string') return document.newElement(tag, props); // Another one for the context setting
...
var IFrame = new Native({
	...
	initialize: function(){
		...
		var onFrameLoad = function(){
		  // These conditional statements block iFrames from working properly
		  /*
...
Window.implement({
	...
	$: function(el, notrash){
		...
		var type = $type(el);
		return ($[type]) ? $[type](el, notrash, this.document) : null; // Can possible set the context here
	},
